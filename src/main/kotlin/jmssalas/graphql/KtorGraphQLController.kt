...
class KtorGraphQLController {
    ...
    private val ktorGraphQLSchema: KtorGraphQLSchema = KtorGraphQLSchema()
    private val graphQL: GraphQL = ktorGraphQLSchema.getGraphQLObject()
    private val ktorGraphQLServer: KtorGraphQLServer = getGraphQLServer()
